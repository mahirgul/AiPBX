...
<div class="card">
    ...
    <form method="POST" autocomplete="off">
        ...
        <div class="form-group" style="margin: 24px 0 0; padding-top: 16px; border-top: 1px solid var(--border-color);">
            <label class="form-label" style="font-weight: 700; color: var(--text-main);"><i class="fas fa-fax" style="color: var(--warning);"></i> <?php echo t('fax_mail_settings.section_device'); ?></label>
        </div>
