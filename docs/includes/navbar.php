...
<nav>
    ...
    <ul class="nav-links">
        ...
        <li>
            <a href="/features" class="<?= (isset($page) && $page === 'features') ? 'active' : '' ?>">
                <?= t('Özellikler', 'Features', 'Funktionen') ?>
            </a>
        </li>
        <li>
            <a href="/tables" class="<?= (isset($page) && $page === 'tables') ? 'active' : '' ?>">
                <?= t('Karşılaştırma & Tablolar', 'Tables & Specs', 'Tabellen') ?>
            </a>
        </li>
        <li>
            <a href="/architecture" class="<?= (isset($page) && $page === 'architecture') ? 'active' : '' ?>">
                <?= t('Mimari', 'Architecture', 'Architektur') ?>
            </a>
        </li>
        <li>
            <a href="/mobile-apps" class="<?= (isset($page) && $page === 'mobile') ? 'active' : '' ?>">
                <?= t('Mobil', 'Mobile Apps', 'Mobil-Apps') ?>
            </a>
        </li>
        <li>
            <a href="/msteams" class="<?= (isset($page) && $page === 'teams') ? 'active' : '' ?>">
        ...
        <li class="nav-dropdown">
            ...
            <div class="nav-dropdown-menu">
                <a href="/installation" class="nav-dropdown-item <?= (isset($page) && $page === 'installation') ? 'active' : '' ?>">
                ...
                <a href="/msteams" class="nav-dropdown-item <?= (isset($page) && $page === 'teams') ? 'active' : '' ?>">
                ...
                <a href="/mobile-apps" class="nav-dropdown-item <?= (isset($page) && $page === 'mobile') ? 'active' : '' ?>">
                ...
                <a href="/callcenter" class="nav-dropdown-item <?= (isset($page) && $page === 'callcenter') ? 'active' : '' ?>">
                ...
                <a href="/security" class="nav-dropdown-item <?= (isset($page) && $page === 'security') ? 'active' : '' ?>">
                ...
                <a href="/api-docs" class="nav-dropdown-item <?= (isset($page) && $page === 'api') ? 'active' : '' ?>">
...
<div class="mobile-drawer" id="mobileDrawer">
    ...
    <ul class="mobile-nav-links">
        ...
        <li><a href="/features" class="mobile-nav-item"><i class="fa-solid fa-bolt" style="color:#f59e0b;"></i> <span><?= t('Özellikler & Modüller', 'Features & Modules', 'Funktionen & Module') ?></span></a></li>
        <li><a href="/tables" class="mobile-nav-item"><i class="fa-solid fa-table-list" style="color:#10b981;"></i> <span><?= t('Karşılaştırma & Tablolar', 'Tables & Specs', 'Tabellen') ?></span></a></li>
        <li><a href="/architecture" class="mobile-nav-item"><i class="fa-solid fa-sitemap" style="color:#6366f1;"></i> <span><?= t('Sistem Mimarisi', 'Architecture', 'Architektur') ?></span></a></li>
        <li><a href="/mobile-apps" class="mobile-nav-item"><i class="fa-solid fa-mobile-screen" style="color:#0ea5e9;"></i> <span><?= t('Mobil Softphone', 'Mobile Softphone', 'Mobile Apps') ?></span></a></li>
        <li><a href="/msteams" class="mobile-nav-item"><i class="fa-brands fa-microsoft" style="color:#6264a7;"></i> <span>Microsoft Teams Direct Routing</span></a></li>
        ...
        <li><a href="/installation" class="mobile-nav-item"><i class="fa-solid fa-terminal" style="color:#0284c7;"></i> <span><?= t('Kurulum Kılavuzu', 'Installation Guide', 'Installation') ?></span></a></li>
        <li><a href="/msteams" class="mobile-nav-item"><i class="fa-brands fa-microsoft" style="color:#6264a7;"></i> <span>Microsoft Teams</span></a></li>
        <li><a href="/mobile-apps" class="mobile-nav-item"><i class="fa-solid fa-mobile-screen" style="color:#10b981;"></i> <span><?= t('Mobil Softphone', 'Mobile Softphone', 'Mobile Apps') ?></span></a></li>
        <li><a href="/callcenter" class="mobile-nav-item"><i class="fa-solid fa-headset" style="color:#ec4899;"></i> <span><?= t('Çağrı Merkezi & Mola', 'Call Center & Breaks', 'Callcenter & Pausen') ?></span></a></li>
        <li><a href="/security" class="mobile-nav-item"><i class="fa-solid fa-shield-halved" style="color:#f59e0b;"></i> <span><?= t('Güvenlik & SBC', 'Security & SBC', 'Sicherheit & SBC') ?></span></a></li>
        <li><a href="/api-docs" class="mobile-nav-item"><i class="fa-solid fa-code" style="color:#8b5cf6;"></i> <span>REST API &amp; WebSocket</span></a></li>
    </ul>
